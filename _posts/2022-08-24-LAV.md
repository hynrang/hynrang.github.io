...
**<b><center>프로젝트명 "TANKE(땅개)"</center></b>**
...
'LAV-AD'는 초등학교를 갓 졸업했을 때 접한 [이 유튜브 채널(Tooner)](https://www.youtube.com/@tooner/videos) 때문에, 시도한 프로젝트다. 이곳의 영상을 하나 둘 보며 나도 이런 것도 할 수 있다는 용기부터 이런 것을 하고 싶다는 욕구까지 많은 영감을 받았다.  

Project TANKE는 실제로 2주간 진행해본 결과물로서, 객체지향을 이해하고 이에 흥미를 붙이는 계기가 되었다.  
