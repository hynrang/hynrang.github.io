...
- 둘.
    ...
    또, activity_main.xml에 작성된 버튼(뷰)을 findViewById()로 찾아내는 것은 유니티에서 오브젝트를 찾을 때 GameObject.FindWithTag()로 찾는 것, 혹은 HTML에서 &lt;div id="Apple"&gt; 등으로 태그에 id 표시를 하는 것과 유사하다고 느껴진다.
