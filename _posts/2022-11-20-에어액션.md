...
접근법이 유니티와 비슷하다. 예를 들어, OnCreate()와 OnStart(), OnResume()는 유니티의 void Start(), void Awake(), void Update()에 대응시킬 수 있을 것 같다.  
또, activity_main.xml에 작성된 버튼(뷰)을 findViewById()는 유니티의 FindWithTag()로 찾는 것, 혹은 HTML에서 &lt;div id="Apple"&gt; 등으로 태그에 id 표시를 하는 것과 유사하다고 느껴진다.

---
# 참고
[Samsung SDK](https://developer.samsung.com/galaxy-spen-remote/s-pen-remote-sdk.html)