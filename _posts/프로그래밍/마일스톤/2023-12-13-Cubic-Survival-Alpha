...
생뚱맞은 3개 정도 아이디어를 생각해보니 **육하원칙 기반 파이썬 라이브러리, 미러리스풍의 카메라 어플리케이션, 2D 모바일 게임** 등이 나왔습니다. 각각 [파이썬 기반 자동주식거래 프로그램](https://hynrang.github.io/posts/ASTP/)이나 Android Studio에 삼성의 에어액션 SDK을 활용해 간단한 어플리케이션을 빌드해본 경험, 또는 [개인 유니티 프로젝트](https://hynrang.github.io/posts/LAV/)에서 파생된 것이었죠.
