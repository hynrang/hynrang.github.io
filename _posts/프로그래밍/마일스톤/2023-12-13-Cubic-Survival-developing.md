...
예를 들어 위에서 차례차례 다룬 무기의 재장전, 플레이 씬으로의 전환 등등의 경우, 재장전 시에는 시야를 좁혀 일시적인 무력감이 표현된다면 재미있겠다는 생각이 들었고, 플레이가 시작될 때 역시 시야를 좁혀 긴장감을 줄 수 있지 않을까 하는 생각에 카메라가 보여주는 영역이 좁아지도록 만들었습니다.
